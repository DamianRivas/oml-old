...
import open.caesar.oml.ide.OmlIdeModule
import open.caesar.oml.ide.OmlIdeSetup
import open.caesar.oml.ide.server.OmlProjectManager
...
class OmlServerLauncher extends ServerLauncher {
